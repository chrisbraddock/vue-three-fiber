...
[![Version](https://img.shields.io/npm/v/@bluera/vue-threejs-test-renderer?style=flat&colorA=000000&colorB=000000)](https://npmjs.com/package/@bluera/vue-threejs-test-renderer)
[![Downloads](https://img.shields.io/npm/dt/@bluera/vue-threejs-test-renderer.svg?style=flat&colorA=000000&colorB=000000)](https://npmjs.com/package/@bluera/vue-threejs-test-renderer)
...
yarn add -D @bluera/vue-threejs-test-renderer
```
...
You've written a complex and amazing webgl experience using [`@bluera/vue-threejs`](https://github.com/blueraai/vue-threejs) and you want to test it to make sure it works even after you add even more features.

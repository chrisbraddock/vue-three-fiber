...
vue-threejs keeps high API overlap with [React Three Fiber](https://github.com/pmndrs/react-three-fiber) where the model is genuinely compatible, and adds Vue-native APIs where Vue offers a better fit.

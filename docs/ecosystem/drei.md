...
`@bluera/vue-threejs-drei` is included in the monorepo at `packages/drei/`. It is not yet published to npm — see [Installation](/getting-started/installation) for the local workspace setup.

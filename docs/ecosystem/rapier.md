...
`@bluera/vue-threejs-rapier` is included in the monorepo at `packages/rapier/`. It is not yet published to npm — see [Installation](/getting-started/installation) for the local workspace setup.
